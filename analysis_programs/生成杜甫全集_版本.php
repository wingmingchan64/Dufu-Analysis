...
//}
			...
			{
				//echo $$陣列名[ "版本" ][ "詩文" ][ 0 ], NL;
				$new_content = $new_content . "2823 " .
					str_replace(
						'〖1〗', '',
						$$陣列名[ "版本" ][ 坐標版本異文、夾注 ][ '〚2823:1〛' ] ) .
					NL . NL .
					$$陣列名[ "版本" ][ "詩文" ][ 0 ] . NL . NL;
				$temp_storage[ '〚2823:2:〛' ] = 
					$$陣列名[ "版本" ][ "詩文" ][ 1 ] . "\n\n";
			...
			{
				$new_content = $new_content .
					'2823 ' . $全目錄[ '2823:2:' ][ 0 ] . NL . NL .
					$temp_storage[ '〚2823:2:〛' ] .
					'向晚波微[一作猶]綠。連空岸脚青。日兼春有暮。愁與醉無醒。漂泊猶杯酒。躊躇此驛亭。相看萬里外。同是一浮萍。' . NL . NL;
				continue;
			}
			if( $頁 == "3052"  && $首 == 2 )
			{
				//echo $$陣列名[ "版本" ][ "詩文" ][ 0 ], NL;
				$new_content = $new_content . "3052 " .					
					$$陣列名[ "版本" ][ "詩文" ][ 1 ] . NL . NL;
				$temp_storage[ '〚3052:1:〛' ] = 
					$$陣列名[ "版本" ][ "詩文" ][ 0 ] . "\n\n";
