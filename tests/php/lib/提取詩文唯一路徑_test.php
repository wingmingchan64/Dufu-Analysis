<?php
/*
php H:\github\Dufu-Analysis\tests\php\lib\提取詩文唯一路徑_test.php
*/
...
echo 提取詩文唯一路徑( '0668', '契闊' ), NL;
//echo 提取詩文唯一路徑( '0003', '割昏曉' ), NL;
//echo 提取詩文唯一路徑( '0003', '陰陽割昏曉' ), NL;
//echo 提取詩文唯一路徑( '0668', '熱腦' ), NL;
/*
$i = 1;
