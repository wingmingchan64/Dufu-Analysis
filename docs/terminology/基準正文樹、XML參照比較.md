...
- 基準正文樹可以外挂後設資料
- 可以利用路徑生成“路徑↔正文”索引，提供快速搜索
- 路徑可以有範圍標記，比如一句中的第三到第五個字、一段中的第一到第四行
- 一條合法的、包含書名的路徑，不論長短（"LUNYU,14,20,47,3,4"、 "LUNYU,14,20,47,3"、"LUNYU,14,20,47"、"LUNYU,14,20"、"LUNYU,14"），都可以用來提取相應的正文
