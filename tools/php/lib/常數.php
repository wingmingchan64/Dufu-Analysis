...
const 完整坐標_路徑陣列 = COORDS_DIR . '完整坐標_路徑陣列';
const 數字對照陣列 = array(
	"1"=>一字組合_坐標, // 單字字碼
	"2"=>二字組合_坐標, "3"=>三字組合_坐標,
	"4"=>四字組合_坐標, "5"=>五字組合_坐標,
...
const 路徑表 = '路徑表';
const 路徑表文件夾 = COORDS_DIR . 路徑表 . DS;
...
const 默認版本文賦文件夾 = 杜甫文件夾.'默認版本'.DS.'文賦'.DS;
...
// 目錄
const 提供默詩碼、簡稱 = '必須提供默認版本詩碼、書目簡 稱。';
const 提供簡稱、版本詩碼 = '必須提供書目簡稱、版本詩碼。';
const 提供默詩碼 = '必須提供默認版本詩碼。';
const 提供結構名稱 = '必須提供數據結構名稱。';
const 提供著述碼 = '必須提供著述碼。'; 
...
const 文賦默認文檔碼 = array(
	...
	'6270','6278','6293','6301','6310','6327','6340',
	'6346','6373','6380','6384','6392','6395','6407',
	'6415','6435','6445','6451','6466','6478','6490'
);
const 帶序言之文賦 = array( '6111', '6248' );
const 文賦篇名 = array(
	'6111'=>'天狗賦',
	'6124'=>'進三大禮賦表',
	'6131'=>'朝獻太清宮賦',
