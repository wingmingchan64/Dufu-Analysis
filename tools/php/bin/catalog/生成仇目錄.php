<?php
/*
php H:\github\Dufu-Analysis\tools\php\bin\catalog\生成仇目錄.php
 */
require_once( 
...
foreach( $lines as $line )
{
	...
	$默詩碼 = $parts[ 2 ];
	$實頁 = $parts[ 3 ];
	$電頁 = str_replace( 'PDF', '', trim( $parts[ 4 ] ) );
	$津頁 = str_replace( 'PDF', '', trim( $parts[ 5 ] ) );
	$津頁 = str_replace( '津', '', $津頁 );
	$簡頁 = str_replace( 'PDF', '', trim( $parts[ 6 ] ) );
